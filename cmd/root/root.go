...
import (
	...
	"github.com/FayeZheng0/ask_pubmed/cmd/echo"
	"github.com/FayeZheng0/ask_pubmed/cmd/httpd"
	"github.com/FayeZheng0/ask_pubmed/cmdutil"
...
func NewCmdRoot(version string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:           "orca <command> <subcommand> [flags]",
		Short:         "gb",
